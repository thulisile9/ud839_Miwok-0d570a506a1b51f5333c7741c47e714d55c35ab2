...
public class WordAdapter extends ArrayAdapter<Word>  {
    ...
    /**Resources ID for the background color fo this list of words*/
     ...
     *
            ...
            */
    public WordAdapter(Context context, ArrayList<Word> words,int colorResourcesId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // find the ImageView in the list_item.xlm layout with the ID image.
